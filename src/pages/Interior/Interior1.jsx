  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        {/* SEO 최적화를 위한 메타 태그 */}
        <title>대전 문화공원 수자인 - 인테리어</title>
        <meta
          name="description"
          content="인테리어 페이지에서는 대전 문화공원 수자인의 고급 인테리어 디자인을 소개합니다. 세련된 디자인과 최첨단 인테리어 요소들이 결합되어, 입주자들에게 고급스러움과 편안함을 제공합니다. 각 공간의 인테리어 스타일과 자재를 확인하여 더욱 매력적인 주거 공간을 발견할 수 있습니다.
"
        />
          ...
          {`
										{
											...
											"@type": "WebPage",
											"name": "대전 문화공원 수자인 - 인테리어",
											"description": "인테리어 페이지에서는 대전 문화공원 수자인의 고급 인테리어 디자인을 소개합니다. 세련된 디자인과 최첨단 인테리어 요소들이 결합되어, 입주자들에게 고급스러움과 편안함을 제공합니다. 각 공간의 인테리어 스타일과 자재를 확인하여 더욱 매력적인 주거 공간을 발견할 수 있습니다.
",
											"url": "https://www.apay.co.kr/Interior/59A"
										}
										`}
        </script>
      </Helmet>
