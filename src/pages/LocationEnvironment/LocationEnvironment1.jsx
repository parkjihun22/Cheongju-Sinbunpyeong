...
"
        ...
        <link
          rel="canonical"
          href="https://www.vaaclubs.com/LocationEnvironment/intro"
        />
...
",
      ...
      <div className={styles.commonBox}>
        ...
        <div className={styles.notice}>
          ※용인 반도체 클러스터 일반산업단지(예정) : 용인시 고시 제2024-775호 「청주 일반산업단지계획(8차 변경) 승인 고시」 (2024.12.26)에 의한 것으로 향후 시행자 (용인일반산업단지(주))에 의해 사업계획이 변경될 수 있습니다.
        </div>
        <div className={styles.notice}>
