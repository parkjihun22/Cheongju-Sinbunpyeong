...
<Helmet>
        ...
        <meta
          name="description"
          content="대전 문화공원 수자인의 브랜드 철학과 가치를 소개합니다. 대우건설의 대표 브랜드 프로지오는 고급스러움과 실용성을 결합한 주거공간을 제공합니다. 고객의 삶을 중심에 둔 설계와 혁신적인 기술, 지속 가능한 개발 철학을 통해 미래를 선도하는 주거 문화를 만들어갑니다. 힐스테이트의 브랜드 스토리와 비전을 확인해보세요.
"
        />
          ...
          {`
                                        {
                                            ...
                                            "description": "대전 문화공원 수자인의 브랜드 철학과 가치를 소개합니다. 대우건설의 대표 브랜드 프로지오는 고급스러움과 실용성을 결합한 주거공간을 제공합니다. 고객의 삶을 중심에 둔 설계와 혁신적인 기술, 지속 가능한 개발 철학을 통해 미래를 선도하는 주거 문화를 만들어갑니다. 힐스테이트의 브랜드 스토리와 비전을 확인해보세요.
",
            ...
            <h1 className={styles.screenReaderOnly}>대전 문화공원 수자인 - 브랜드소개</h1>
			<p className={styles.screenReaderOnly}>대전 문화공원 수자인의 신뢰와 품질을 최우선으로 여기는 브랜드입니다. 최첨단 설계와 고급 자재를 사용하여 입주자에게 최고의 주거 환경을 제공합니다. 지속적인 혁신과 고객 만족을 위한 브랜드 철학을 바탕으로, 미래 지향적인 주택을 제시하는 
        의 브랜드 가치를 경험해보세요
			</p>	
